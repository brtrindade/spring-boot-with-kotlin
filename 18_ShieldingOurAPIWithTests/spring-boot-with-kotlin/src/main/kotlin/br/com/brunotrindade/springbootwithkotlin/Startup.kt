package br.com.brunotrindade.springbootwithkotlin
...
fun main(args: Array<String>) {
    ...
    val result = passwordEncoder.encode("mocked-password") // result of encrypted password for mock user credentials on db
