package br.com.brunotrindade.springbootwithkotlin.integrationtests.testcontainer
...
open class AbstractIntegrationTest {
    internal class Initializer : ApplicationContextInitializer<ConfigurableApplicationContext>{
        ...
        companion object {
            private var postgres: PostgreSQLContainer<*> = PostgreSQLContainer("postgres:latest")
